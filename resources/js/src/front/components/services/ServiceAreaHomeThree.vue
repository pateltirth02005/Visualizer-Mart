...
const service_data = [
  ...
  {
    id: 6,
    icon: `<svg width="66" height="53" viewBox="0 0 66 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
  ...
  {
    id: 8,
    icon: `<svg width="52" height="48" viewBox="0 0 52 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
  ...
  <div class="tp-service-area pb-90 z-index">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="tp-service-section-wrapper mb-60 d-flex justify-content-between align-items-end">
            <h3 class="tp-section-title-3 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".3s">Accounting Software
              <br /> That <span>Handles it All.</span>
            </h3>
            <router-link class="tp-btn-blue-lg tp-btn-hover mb-10 alt-color-black wow tpfadeRight" data-wow-duration=".9s"
              data-wow-delay=".5s" to="/service-details">
      ...
      <div class="row">
        ...
        <div class="col-xl-8 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".5s">
          <div class="tp-service-3-item mb-30 p-relative z-index" :style="{ 'background-image': `url(${bg_img})` }">
            ...
            <div class="tp-service-3-content">
              ...
              <h4 class="tp-service-3-title-sm"><router-link to="/service-details">Generate, Manage, and Convert leads <br />
                  into Customers. Automatically</router-link></h4>
            </div>
        ...
        <div v-for="(item, i) in service_data" :key="i" class="col-xl-4 col-lg-6 col-md-6 wow tpfadeRight"
          data-wow-duration=".9s" data-wow-delay=".6s">
          <div class="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
            <div class="tp-service-sm-icon" v-html="item.icon">
            ...
            <div class="tp-service-sm-content">
              ...
              <div class="tp-service-sm-link">
                <router-link to="/service-details">Learn More <i class="far fa-arrow-right"></i></router-link>
              </div>
            </div>
          </div>
        </div>
