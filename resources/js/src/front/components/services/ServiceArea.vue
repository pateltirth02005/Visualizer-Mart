...
<script setup>
import bg_img from "~/assets/img/service/service-3-bg.png";
...
const service_data = [
  ...
  {
    id: 1,
    img: `<svg width="66" height="53" viewBox="0 0 66 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
  ...
  {
    id: 2,
    img: `<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
  ...
  {
    id: 3,
    img: `<svg width="52" height="48" viewBox="0 0 52 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
  ...
  {
    id: 5,
    img: `<svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.5987 29.5987V37.3987H37.3987V16.5986H16.5987V19.1986" stroke="CurrentColor"
  ...
  {
    id: 6,
    img: `<svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M51.4 29C51.4 44.464 45.7588 57 38.8 57M38.8 1C43.9668 1 48.4073 7.91093 50.3516 17.8"
                  stroke="CurrentColor" stroke-width="1.5" stroke-linecap="round" />
                <path
                  ...
                  stroke="CurrentColor" stroke-width="1.5" stroke-linecap="round" />
                <path d="M13.6 57C20.5588 57 26.2 44.464 26.2 29C26.2 13.536 20.5588 1 13.6 1" stroke="CurrentColor"
                  stroke-width="1.5" />
                <path
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="tp-service-section-wrapper mb-60 d-flex justify-content-between align-items-end">
            ...
            <router-link class="tp-btn-inner tp-btn-hover alt-color-black wow tpfadeRight" data-wow-duration=".9s"
              data-wow-delay=".3s" to="/service-details">
      ...
      <div class="row">
        ...
        <div class="col-xl-8 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
          <div class="tp-service-3-item mb-30 p-relative z-index" :style="`background-image: url(${bg_img})`">
            <div class="tp-service-3-icon">
              <img src="~/assets/img/service/sv-icon-3-1.png" alt="image-here">
            </div>
            <div class="tp-service-3-content">
              <span>CRM Management</span>
              <h4 class="tp-service-3-title-sm">
                <router-link to="/service-details">
                  Generate, Manage, and Convert leads <br />
                  into Customers. Automatically
                </router-link>
              </h4>
            </div>
            <div class="tp-service-3-btn">
              <router-link class="tp-btn-white-solid" to="/service-details">Learn More</router-link>
            </div>
            <div class="tp-service-3-shape">
              <img src="~/assets/img/service/service-shape-3-1.png" alt="image-here">
            </div>
          </div>
        </div>

        <div v-for="(item, i) in service_data" :key="i" class="col-xl-4 col-lg-6 col-md-6 wow tpfadeUp"
          data-wow-duration=".9s" data-wow-delay=".5s">
          <div class="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
            <div class="tp-service-sm-icon" v-html="item.img">

            </div>
            <div class="tp-service-sm-content">
              <span>{{ item.title }}</span>
              <h3 class="tp-service-sm-title">
                <router-link to="/service-details"> <a v-html="item.description"></a></router-link>
              </h3>
