  ...
  <div class="tp-service-2__area p-relative pt-70 pb-160">
    ...
    <div class="container z-index-5">
      <div class="row align-items-center mb-50">
        <div class="col-xl-6 col-lg-6">
          <div class="tp-service-2__section-box">
            <h3 class="tp-section-title-lg pb-20" v-html="title"></h3>
            <p>{{ des }}</p>
          </div>
        </div>
        <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".3s">
          <div
            class="tp-service-2__user-box p-relative d-flex justify-content-lg-start justify-content-lg-end align-items-center">
            <div class="tp-service-2__user-shape">
              <svg width="470" height="18" viewBox="0 0 470 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  fill="url(#paint0_linear_552_4801)"></path>
                <defs>
                  <linearGradient id="paint0_linear_552_4801" x1="0" y1="9" x2="470" y2="9"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#491EB8" stop-opacity="0"></stop>
                    <stop offset="1" stop-color="#DA2A51"></stop>
                  </linearGradient>
                </defs>
              </svg>
            </div>

            <div v-for="(item, i) in users_data" :key="i" class="tp-service-2__user">
              <span v-html="item.users_count"></span>
      ...
      <div class="row gx-60">
        ...
        <div v-for="(item, i) in service_data" :key="i" class="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp"
          ...
          <div class="tp-service-2__item-wrapper p-relative">
            <div class="tp-service-2__item d-flex justify-content-between flex-column">
              ...
              <div class="tp-service-2__text">
                ...
                <router-link class="tp-service-2__link" to="/service-details">Explore<i class="far fa-arrow-right"></i>
                </router-link>
              </div>
            </div>
            <div :class="`tp-service-2__bg-shape tp-service-2__color-${item.color}`"></div>
          </div>
        </div>
