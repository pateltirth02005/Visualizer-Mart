...
const animateHeroText = () => {
  if (hero_text_anim.value) {
    const elements = Array.from(document.querySelectorAll('.child-2'));
...
<template>
  ...
  <div class="tp-hero-area tp-hero-five__ptb-5 p-relative grey-bg-2 fix">
    <div class="tp-hero-five__shape-2">
      <img src="~/assets/img/hero/hero-circle-5-1.png" alt="image-here">
    </div>
    <div class="tp-hero-five__shape-3">
      <img src="~/assets/img/hero/hero-circle-5-2.png" alt="image-here">
    </div>
    <div class="tp-hero-five__shape-4">
      <img src="~/assets/img/hero/hero-circle-5-3.png" alt="image-here">
    </div>
    <div class="container">
        ...
        <div class="col-xl-7 col-lg-6 order-2">
          <div class="tp-hero-five-section-wrap">
            <div class="tp-hero-five-section-box z-index">
              <h3 ref="hero_text_anim" class="tp-hero-title-5 hero-text-anim-2">
                <i><i ref="heroTextAnimChildren" class="child-2">Offer The <br /></i></i>
                <i>
                  <i ref="heroTextAnimChildren" class="child-2">
              ...
              <p class="wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">A simple solution for building the
                optimal work <br />
            ...
            <div class="tp-hero-five-btn-box d-flex align-items-center wow tpfadeUp" data-wow-duration=".9s"
              ...
              <router-link class="tp-btn-grey mb-20" to="/service-details">Try a Damo</router-link>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="tp-hero-five-2-thumb-main p-relative">
      <div class="tp-hero-five-2-thumb">
        <img class="tp-hero-five-2-thumb-inner" src="~/assets/img/hero/hero-shape-5-1-1.png" alt="image-here">
      </div>
      <div class="tp-hero-five-2-sub-img-1 d-none d-md-block">
        <img src="~/assets/img/hero/home-shape-1-1.png" alt="image-here">
      </div>
      <div class="tp-hero-five-2-sub-img-2 d-none d-md-block">
        <img src="~/assets/img/hero/home-shape-1-2.png" alt="image-here">
      </div>
    </div>
  </div>
  <!-- tp-hero-area-end -->
