    ...
    <div class="signin-banner-left-box signin-banner-bg p-relative" :style="`background-image: url(${bg_img})`">
      ...
      <div class="signin-banner-left-wrap">
        <div class="signin-banner-title-box mb-100">
          <h4 class="signin-banner-title tp-char-animation">Welcome To <br> Your Softec System.</h4>
        </div>
        ...
        <div class="signin-banner-from-box">
          ...
          <form @submit.prevent>
            <div class="row">
              ...
              <div class="col-12">
                <div class="postbox__comment-input mb-30">
                  <input id="myInput" class="inputText password" :type="passwordType" required>
                  <span class="floating-label">Password</span>
                  <span id="click" class="eye-btn" @click="togglePassword"> 

                    <span class="eye-off">

                      <svg v-if="passwordType === 'password'" width="18" height="18" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_2547_24206)">
                          ...
                          <path d="M1.87305 1.97131L23.873 23.9713" stroke="black" stroke-width="2" stroke-linecap="round"
                      ...
                      <svg v-if="passwordType === 'text'" width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.5"
