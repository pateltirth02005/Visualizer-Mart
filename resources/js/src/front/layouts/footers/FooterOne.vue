            ...
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-7 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                <div class="tp-footer__widget footer-col-1">
                  <router-link to="/" class="tp-footer__widget-logo mb-10">
                  ...
                  <div class="tp-footer__social">
                    <router-link target="_blank" to="https://www.facebook.com"><i class="fab fa-facebook-f"></i></router-link>
                    <router-link target="_blank" to="https://www.twitter.com"><i class="fab fa-twitter"></i></router-link>
                    <router-link target="_blank" to="https://www.linkedin.com"><i class="fab fa-linkedin-in"></i>
                    </router-link>
                    <router-link target="_blank" to="https://www.vimeo.com"><i class="fab fa-vimeo-v"></i></router-link>
                  </div>
                </div>
              </div>
                  ...
                  <div class="tp-footer__contact-info tp-footer__icon-space">
                    <ul>
                      ...
                      <li>
                        ...
                        <a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z" target="_blank">1234 North
                          Avenue Luke Lane, South Bend,</a>
                      </li>
                    </ul>
                  </div>
                </div>
