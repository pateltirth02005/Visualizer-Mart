                    ...
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'dashboard'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/admin/dashboard" @click="toggleMobileMenu">{{ $t('Dashboard')
                                        }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'admin'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/admin/profile" @click="toggleMobileMenu">{{ $t('profile')
                                        }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/admin/user-account-settings" @click="toggleMobileMenu">{{
